...
export default function RakshithaCharacter({
  ...
  // Load Rakshitha's GLB model
  const gltf = useGLTF('/Rakshitha.glb');
  ...
  return (
    <group>
      ...
      <Html center position={[0, 2.2, 0]} style={{ pointerEvents: 'none' }}>
        <div style={{ color: '#fff', fontWeight: 'bold', textShadow: '0 1px 4px #000', fontSize: 18 }}>Rakshitha</div>
      </Html>
      ...
      {showMessage && (
        <Html center position={[0, 3.2, 0]} style={{ pointerEvents: 'none' }}>
          <div style={{
            ...
            Hi, I'm Rakshitha! Ready to explore the world with you!
          </div>
        </Html>
      )}
    </group>
